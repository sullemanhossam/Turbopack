          ...
          <div class="first-line-content">
            ...
            <div class="form-group">
              ...
              >
                ...
                <option :value="4">
                  {{ $t('general.channels') }} - {{ $t('actions.descending') }}
                </option>
                <option :value="1">{{ $t('general.name') }}</option>
                <option :value="2">
                  {{ $t('general.name') }} - {{ $t('actions.descending') }}
                </option>
                <option :value="5">{{ $t('general.due-date') }}</option>
                <option :value="6">
                  {{ $t('general.due-date') }} - {{ $t('actions.descending') }}
                </option>
              </select>
            </div>
          </div>
...
import { parseFilter, parseQueryFilter } from '../utils';
export default {
  data() {
    return {
      context: 'table',
