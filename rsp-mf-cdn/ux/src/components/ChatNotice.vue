<template>
  <div
    ...
    :data-plain-text="`[${parseTime(message.created_on).format('YYYY-MM-DD hh:mm A')}] ${
...
import { parseMessageContent, parseTime } from '../utils';
  ...
  methods: {
    ...
    onClickMessage(e) {
      ...
      if (e.target.tagName === 'A') {
        ...
        if (type === 'meeting') {
          const { call_hash, server_address } =
      ...
      if (
        ...
        const { action_id, channel_id, action_name } =
          this.message.content.i18n.params;
