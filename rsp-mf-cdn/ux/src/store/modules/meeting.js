  ...
  actions: {
    ...
    async joinRoom(context) {
      ...
      try {
        ...
        const { display_name, has_avatar, updated_on_ts } =
          this.getters['core/getUser']();
    ...
    async updateScreenSharing(
      ...
      try {
        ...
        */
        ...
        const { screenSharingResolution, screenSharingFrameRate } =
        ...
        if (start) {
          ...
          context.commit('addResource', {
            ...
            codec:
              screenSharingProducer.rtpParameters.codecs[0].mimeType.split(
                '/',
              )[1],
          });
    ...
    async updateWebcam(
      ...
      let { mediasoupDevice, webcamProducer, sendTransport, useSimulcast } =
        context.state;
        ...
        */
        ...
        if ((restart && webcamProducer) || start) {
          ...
          context.commit('addResource', {
            ...
            codec:
              webcamProducer.rtpParameters.codecs[0].mimeType.split('/')[1],
          });
