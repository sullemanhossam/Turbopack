<template>
  <div class="page-content">
    <MeetingWidget />
    <Loader loading full v-if="!file.displayname && this.$store.state.loading['files/info']" />
...
export default {
  ...
  computed: {
    ...
    isFile() {
      if (this.path !== "") {
        return this.path.indexOf(".") > -1 || (this.file && this.file.type && this.file.type !== "folder");
      } else {
        return false;
      }
    },
