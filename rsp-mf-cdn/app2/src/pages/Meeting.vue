  ...
  <div class="page-content d-flex">
    ...
    <MeetingFragment>
      <template v-slot:left-side>
        <button class="btn btn-icon mr-auto" v-if="user && user.id" @click="toggleSwitcher">
      ...
      <template v-slot:right-side>
        <button class="btn btn-icon btn-badge ml-auto" @click="toggleChat">
          <UnreadBadge :unread_count="meeting.chatUnreadCount" v-if="meeting.chatUnreadCount > 0 && !meeting.isChatOpen" />
