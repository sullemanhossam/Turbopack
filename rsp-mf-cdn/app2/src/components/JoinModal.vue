<template>
  <Modal name="join-channel" :title="$t('channels.public-channel')" @opened="onOpen">
    ...
    <form v-if="channel" novalidate="true" @submit="onSubmit">
      ...
      <div class="d-block text-center">
        <button type="button" class="btn btn-default btn-rounded mx-1" @click="() => this.$modal.hide('join-channel')">
          {{ $t("channels.public-explore-contents") }}
        </button>

        <button v-if="user.id" tyle="submit" class="btn btn-primary btn-rounded mx-1">
