    ...
    <div class="container-fluid">
      ...
      <div v-else>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-4" v-if="user.teamRole.can('teams.manage')">
            <Usage :team="team" />
          </div>
...
import OpenChannels from "@/components/Teams/Cards/OpenChannels.vue";
import PendingActions from "@/components/Teams/Cards/PendingActions.vue";
...
export default {
  ...
  computed: {
    ...
    showOpenChannels() {
      return this.user.teamRole.can("teams.manage") || (this.team && this.team.open_channels && this.team.open_channels.length);
    },
  },
  watch: {
    teamId: {
