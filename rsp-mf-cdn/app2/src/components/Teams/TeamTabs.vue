  ...
  <div class="teams-tabs">
    <perfect-scrollbar :suppressScrollY="true">
      <div class="tabs-container">
        <router-link
          :to="isNotAllChannels(team.id) ? { path: `/team/${team.id}`, team } : '/'"
    ...
    <div class="team-tab-right-controls">
      ...
      <a
        v-if="isNotAllChannels(currentActiveTab) && user.teamRole.can('teams.manage')"
        class="manage-team"
...
import TeamCreateModal from "@/components/Modals/TeamCreate";
