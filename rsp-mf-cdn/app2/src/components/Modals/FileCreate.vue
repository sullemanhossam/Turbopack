<template>
  <portal to="modal-wrapper">
    <Modal class="modal-subwrapper" name="file-create" title="Add Page" @before-open="beforeOpen" @opened="onOpen">
      ...
      <form novalidate="true" @submit="onSubmit">
        ...
        <button class="btn btn-primary btn-rounded mx-auto d-block">Create Page</button>
      </form>
    </Modal>
  </portal>
</template>
