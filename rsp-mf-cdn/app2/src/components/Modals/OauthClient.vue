<template>
  <Modal name="oauth-client" :title="client.name" class="picker-modal" @before-open="onOpen">
    <form novalidate="true">
      <div class="form-group">
        <label for="description" class="mb-2">Client Description</label>
        <textarea class="form-control disabled" disabled :value="client.description"></textarea>
      </div>
      ...
      <div class="form-group">
        ...
        <textarea rows="5" class="form-control disabled" disabled :value="`${origin}/oauth?${query}`"></textarea>
      </div>
    </form>
  </Modal>
</template>
