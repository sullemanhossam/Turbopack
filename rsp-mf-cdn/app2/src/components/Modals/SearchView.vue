<template>
  <Modal name="search-view" title="Search All" theme="noPadding" class-name="search-view" @before-open="beforeOpen" @opened="onOpen">
    <form
    ...
    <div class="tabbed--wrapper search">
      ...
      <div class="tabbed--content search-results search-results-view">
        ...
        <perfect-scrollbar class="h-100" v-if="!isSearching" :options="{ wheelPropagation: false }">
                ...
                <div class="list-group popover-list popover-list--auto">
                  ...
                  >
                    <div class="w-100">
                      ...
                      <p v-for="highlight in item.highlighted" v-bind:key="highlight">
                ...
                <div class="list-group popover-list popover-list--auto">
                  ...
                  >
                    <div class="w-100 d-flex align-items-center justify-content-between">
                      ...
                      <div v-if="item.file.is_wiki_file" class="member-badge badge">
                        {{ $t("general.wiki") }}
                      </div>
                    </div>
                  </router-link>
        ...
        this.timeout = setTimeout(
          async () => {
            ...
            await this.$store.dispatch(
              "core/search",
              !this.channel ? { query: value, limit: 30 } : { query: value, channel: this.channel.id, limit: 30 }
            );
            this.$set(this, "searching", this.searching - 1);
          },
