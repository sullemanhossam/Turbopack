      ...
      <div class="task-pre-icons task-pre-icons-col">
        ...
        <div
          ...
          :class="{
            ...
            [getDueOfClosestDueChildren(action).class]: action.meta && !action.meta.expanded,
          }"
        >
        ...
        <Checkbox :checked="!!action.action_status" @change="(v) => toggleActionStatus(v, action, index)" />
      </div>
