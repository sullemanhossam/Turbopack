<template>
  <div class="empty-channel">
    ...
    <div class="iconic-hand">
      ...
      <small v-if="channel.public_url === null" v-html="$t('channels.welcome-email-hint', { memberEmail })"></small>
      <small
        v-else
        v-html="
    ...
    <div class="cta-new-channel" v-if="!IS_READONLY">
      <button class="btn btn-primary btn-rounded" @click="openNewMemberModal" v-if="!channel.one_one">
