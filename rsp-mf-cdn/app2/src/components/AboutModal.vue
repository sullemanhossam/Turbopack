<template>
  <Modal name="about-modal" title="" theme="noPadding" class-name="about-settings" @opened="onOpen">
    ...
    <div class="version-info">
      ...
      <a class="btn btn-primary text-white mx-auto mt-4" target="_blank" href="https://www.airsend.io/support/releasenotes">{{
        $t("general.version-changes")
      }}</a>
    </div>
