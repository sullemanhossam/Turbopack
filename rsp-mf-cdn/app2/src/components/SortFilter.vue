<template>
  <div class="row">
    <div class="col-md-12 sort-filter justify-content-between align-items-center d-flex">
        ...
        <span class="filter-dropdown" @click.prevent.stop>
          <Popover placement="bottom-end">
            <span class="select-filter-title">
              ...
              <b>
                {{ $t(findFilterLabelByValue("filterBy", userPreferences.listing.filterBy)) }}
              </b>
            ...
            <template slot="popover">
              <div class="dropdown-items">
                ...
                >
                  <Icon
                    :style="{
                      ['visibility']: filter.value === userPreferences.listing.filterBy ? 'visible' : 'hidden',
                    }"
                    family="far"
                    name="check"
                  />
        ...
        <span class="sort-dropdown ml-3">
          <Popover placement="bottom-end">
            <span class="select-filter-title">
              ...
              <b>{{ $t(findFilterLabelByValue("sortBy", userPreferences.listing.sortBy)) }}</b>
              <Icon family="far" name="chevron-down" />
            </span>
            ...
            <template slot="popover">
              <div class="dropdown-items">
                ...
                >
                  <Icon
                    :style="{
                      ['visibility']: userPreferences.listing.sortBy.includes(sort.value) ? 'visible' : 'hidden',
                    }"
                    family="far"
                    name="check"
                  />
  ...
  methods: {
    ...
    findFilterLabelByValue(type, filterValue) {
      if (type === "filterBy") {
        ...
        return this.sortOptions.find((sort) => filterValue.includes(sort.value)).label;
      }
    },
  },
  watch: {
