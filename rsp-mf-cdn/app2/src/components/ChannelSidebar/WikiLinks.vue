  ...
  >
    ...
    <template slot="popover">
      <div class="dropdown-items">
        ...
        <div class="dropdown-items">
          <WikiTree v-for="(link, index) in links" :tree="link" :isRootFolder="true" :current="current" :channel="channel" :key="index" />
        </div>
      </div>
    </template>
  </Popover>
...
import WikiTree from "@/components/ChannelSidebar/WikiTree.vue";
