  ...
  <Modal name="finalize" title="Complete your AirSend signup" @opened="onOpen">
    <form novalidate="true" @submit="onSubmit">
      ...
      <div class="form-group" :class="{ [`is-invalid`]: errors['user'] }">
        ...
        <input id="user" ref="user" v-model="form.user" type="email" class="form-control" :placeholder="$t('auth.email-placeholder')" disabled />
      ...
      <div class="form-group" :class="{ [`is-invalid`]: errors['name'] }">
        ...
        <input id="name" ref="name" v-model="form.name" type="text" class="form-control" :placeholder="$t('auth.name-placeholder')" />
      ...
      <div class="form-group" :class="{ [`is-invalid`]: errors['password'] }">
        <label for="password" class="mb-2">{{ $t("auth.password-choose") }}</label>
        <input id="password" ref="password" v-model="form.password" type="password" class="form-control" placeholder="******" />
