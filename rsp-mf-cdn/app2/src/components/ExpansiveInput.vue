<template>
  <div class="expansive-input-wrapper" :class="{ ['is-mobile']: isMobile }">
    <div class="form-group form-group--search input-container" :class="{ ['is-searching']: isSearching && isMobile }">
      <button type="button" class="btn btn-icon btn-sm search-btn" @click="isSearching = !isSearching">
    ...
    <div class="options-container" :class="{ ['is-searching']: isSearching && isMobile }">
      <slot></slot>
    </div>
  </div>
</template>
