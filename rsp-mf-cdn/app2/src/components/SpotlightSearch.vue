<template>
  <div class="spotlight-search" :class="{ visible: isSpotlightVisible }" v-hotkey="keymap">
          ...
          <div class="list-group">
            ...
            >
              ...
              <div class="list-group-item-content">
                ...
                <h5 v-else>
                  {{ !item.one_one ? item.channel_name : item.counterpart ? item.counterpart.display_name : "Direct Conversation" }}
                </h5>
...
export default {
    ...
    suggestedChannels() {
      if (this.query) {
        ...
        let directMessageUsers = _.filter(this.channels, { one_one: true }).map((channel) => {
          ...
          return this.getCounterpart(channel) && this.getCounterpart(channel).id;
        });
  ...
  methods: {
    ...
    onKeyDown(e) {
      ...
      if (key === "ArrowDown" && this.currentIndex < 4 && this.currentIndex < this.aggregatedResults.length - 1) {
        this.currentIndex++;
      }
