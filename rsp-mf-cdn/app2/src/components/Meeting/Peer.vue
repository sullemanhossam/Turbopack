<template>
  <div class="meeting-peers-list-item">
    <div class="meeting-peer" :class="{ [`meeting-peer--speaking`]: activeSpeaker === peer.id }" @click="details">
      <MeetingVideo v-if="screenShare && consumers.screen" :consumer="consumers.screen" />
      ...
      />
      <div
        v-if="consumers.mic && !consumers.webcam && !screenShare && (selfPeer ? !consumers.mic.paused : !consumers.mic.remotelyPaused)"
      ...
      <div class="meeting-peer-menu">
        <Popover container=".meeting-fragment" trigger="manual" :open="isMoreOptionsOpen" @hide="isMoreOptionsOpen = false">
          <button
            v-tooltip="{
              delay: 1000,
              offset: 10,
          ...
          <template slot="popover">
            <div class="dropdown-items">
              ...
              <div class="dropdown-divider" v-if="(consumers.mic && !consumers.mic.remotelyPaused) || consumers.webcam || consumers.screen"></div>
      ...
      <div class="meeting-peer-info">
        ...
        <h4 v-else>
          <Icon v-if="consumers.mic && (consumers.mic.remotelyPaused || consumers.mic.paused)" name="microphone-slash" />
