<template>
  <div class="editor">
    <EditorMenuBubble class="menububble" :editor="editor" @hide="hideLinkMenu" v-slot="{ commands, isActive, getMarkAttrs, menu }">
    ...
    <EditorMenuBar :editor="editor" v-slot="{ commands, isActive }">
      <div class="menubar">
        ...
        <button style="display: none" class="menubar__button" :class="{ 'is-active': isActive.strike() }" @click="commands.strike">
          <Icon family="far" name="strikethrough" />
        </button>

        <button style="display: none" class="menubar__button" :class="{ 'is-active': isActive.underline() }" @click="commands.underline">
        ...
        <button class="menubar__button" v-tooltip="{ delay: 1000, offset: -5, content: 'Horizontal Rule' }" @click="commands.horizontal_rule">
          <Icon family="far" name="horizontal-rule" />
        </button>

        <button class="menubar__button" v-tooltip="{ delay: 1000, offset: -5, content: 'Undo' }" @click="commands.undo">
          <Icon family="far" name="undo" />
        </button>

        <button class="menubar__button" v-tooltip="{ delay: 1000, offset: -5, content: 'Redo' }" @click="commands.redo">
