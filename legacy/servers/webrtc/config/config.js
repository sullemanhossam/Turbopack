...
module.exports =
{
	...
	*/
	...
	redisOptions : {
		host : (process.env.AIRSEND_REDIS_HOST) ? process.env.AIRSEND_REDIS_HOST : 'localhost',
		port : (process.env.AIRSEND_REDIS_PORT) ? process.env.AIRSEND_REDIS_PORT : 6379
	},

	apiEndpoint: (process.env.AIRSEND_API_ENDPOINT) ? process.env.AIRSEND_API_ENDPOINT : 'http://web',

	apiOptions: {
		host: (process.env.AIRSEND_API_HOST) ? process.env.AIRSEND_API_HOST : 'web',
		port : (process.env.AIRSEND_API_PORT) ? process.env.AIRSEND_API_PORT : 443
	},
	...
	tls          :
	{
		cert : `${__dirname}/../ssl/STAR_airsend_io.pem`,
		// passphrase: 'key_password'
		key  : `${__dirname}/../ssl/STAR_airsend_io.key`
	},
	// listening Host or IP
	// If omitted listens on every IP. ("0.0.0.0" and "::")
	// listeningHost: 'localhost',
	// Listening port for https server.
	listeningPort         : (process.env.AIRSEND_WEBRTC_PORT) ? process.env.AIRSEND_WEBRTC_PORT : 443,
	...
	*/
	...
	mediasoup            :
	{
		...
		worker     :
		{
			logLevel : (process.env.AIRSEND_WEBRTC_LOG_LEVEL) ? process.env.AIRSEND_WEBRTC_LOG_LEVEL : 'warn',
			logTags  :
			[
				'info',
				'ice',
			...
			rtcMinPort : (process.env.AIRSEND_WEBRTC_MIN_PORT) ? parseInt(process.env.AIRSEND_WEBRTC_MIN_PORT) : 40000,
			rtcMaxPort : (process.env.AIRSEND_WEBRTC_MAX_PORT) ? parseInt(process.env.AIRSEND_WEBRTC_MAX_PORT) : 49999
		},
		...
		webRtcTransport :
		{
			...
			[
				...
				{ ip: '0.0.0.0', announcedIp: (process.env.AIRSEND_DEPLOYMENT_HOSTNAME) ? process.env.AIRSEND_DEPLOYMENT_HOSTNAME : null }
